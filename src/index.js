...
export const makeMidiEnhancer = ({midiOptions,
    stateKey = 'midi',
    requestMIDIAccess = global.navigator.requestMIDIAccess.bind(global.navigator)
}) => next => (userReducer, preloadedState) => {
